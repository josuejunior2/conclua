    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-body flex-start">
          ...
          <div>Se proceder, você irá excluir a atividade {{ $atividade->titulo }} do acadêmico {{ $atividade->Orientacao->AcademicoTrashed->UserTrashed->nome }}, inclusive todos os arquivos relativos à atividade.
