...
<body  class=" d-flex flex-column">
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <div class="card card-md d-flex justify-content-center align-items-center">
            <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                <a href="{{ route('orientadorgeral.create') }}" class="btn btn-teal w-100">
                    Orientador
                </a>
            </div>
            <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                <a href="{{ route('academico.create') }}" class="btn btn-cyan w-100">
                    Academico
                </a>
            </div>
        </div>
