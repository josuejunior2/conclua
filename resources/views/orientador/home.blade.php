                            ...
                            <div class="row">
                                ...
                                <div class="text-muted">
                                    @if (isset($orientacao->AcademicoEstagio))
                                        Estágio - data de vinculação: {{ $orientacao->created_at->format('d/m/Y') }}
                                    @elseif (isset($orientacao->AcademicoTCC))
                                        TCC - data de vinculação: {{ $orientacao->created_at->format('d/m/Y') }}
                                    @endif
                                </div>
                                </div>
                                {{-- <div class="col-auto align-self-center">
