                    ...
                    <form method="POST" action="{{ route('orientador.store', ['orientador' => $orientador]) }}" autocomplete="off" novalidate>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="mb-3">
                                ...
                                <div>
                                    <input name="password" type="password" class="form-control" placeholder="Password"  value="{{ isset($orientador) && $orientador->password ? $orientador->password : old('password', '') }}">
                        ...
                        <div class="col-md">
                            ...
                            <select class="form-select" name="formacao_id" id="formacao_id">
                                ...
                                @foreach($formacoes as $f)
                                    <option value="{{ $f->id }}" {{ (isset($orientador) && $orientador->formacao_id == $f->id) || old('formacao_id') == $f->id ? 'selected' : '' }}>
                                        {{ $f->nome }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md">
                            ...
                            <select class="form-select" name="area_id" id="area_id">
                                ...
                                @foreach($areas as $a)
                                    <option value="{{ $a->id }}" {{ (isset($orientador) && $orientador->area_id == $a->id) || old('area_id') == $a->id ? 'selected' : '' }}>
                                        {{ $a->nome }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md">
                                ...
                                <input id="areaPesquisa1" name="areaPesquisa1"  type="text" class="form-control mb-3" value="{{ isset($orientador) && $orientador->areaPesquisa1 ? $orientador->areaPesquisa1 : old('areaPesquisa1', '') }}">
                                ...
                                <input id="areaPesquisa2" name="areaPesquisa2"  type="text" class="form-control mb-3" value="{{ isset($orientador) && $orientador->areaPesquisa2 ? $orientador->areaPesquisa2 : old('areaPesquisa2', '') }}">
                                ...
                                <input id="areaPesquisa3" name="areaPesquisa3"  type="text" class="form-control mb-3" value="{{ isset($orientador) && $orientador->areaPesquisa3 ? $orientador->areaPesquisa3 : old('areaPesquisa3', '') }}">
                                ...
                                <input id="areaPesquisa4" name="areaPesquisa4"  type="text" class="form-control mb-3" value="{{ isset($orientador) && $orientador->areaPesquisa4 ? $orientador->areaPesquisa4 : old('areaPesquisa4', '') }}">
                                ...
                                <input id="areaPesquisa5" name="areaPesquisa5"  type="text" class="form-control mb-3" value="{{ isset($orientador) && $orientador->areaPesquisa5 ? $orientador->areaPesquisa5 : old('areaPesquisa5', '') }}">
                            ...
                            <div class="col-md">
                                ...
                                <input id="subArea1" name="subArea1"  type="text" class="form-control mb-3" value="{{ isset($orientador) && $orientador->subArea1 ? $orientador->subArea1 : old('subArea1', '') }}">
                                <span class="{{ $errors->has('subArea1') ? 'text-danger' : '' }}">
                                    {{ $errors->has('subArea1') ? $errors->first('subArea1') : '' }}
                                </span>
                                <div class="form-label">Sub-área 2</div>
                                <input id="subArea2" name="subArea2"  type="text" class="form-control mb-3" value="{{ isset($orientador) && $orientador->subArea2 ? $orientador->subArea2 : old('subArea2', '') }}">
                                <span class="{{ $errors->has('subArea2') ? 'text-danger' : '' }}">
                                    {{ $errors->has('subArea2') ? $errors->first('subArea2') : '' }}
                                </span>
                                <div class="form-label">Sub-área 3</div>
                                <input id="subArea3" name="subArea3"  type="text" class="form-control mb-3" value="{{ isset($orientador) && $orientador->subArea3 ? $orientador->subArea3 : old('subArea3', '') }}">
