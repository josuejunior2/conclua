<div class="row">
    ...
    @include('orientador.atividade.modal.destroy_arquivo_aux')
    <div class="col-4">
          ...
          <div class="card-body">
            ...
            <div class="mt-4">
              <div class="row">
                ...
                <div class="col-auto">
                    <form id="form_destroy_arquivo_aux_{{ $arquivo->id }}" method="post" action="{{ route('orientador.atividade.destroy.arquivo.aux', ['arquivo' => $arquivo]) }}">
                        @method('DELETE')
                        @csrf
