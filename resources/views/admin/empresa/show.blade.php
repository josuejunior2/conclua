...
@include('admin.empresa.modal.destroy')
@section('content')
...
<div class="card m-3">
    <div class="card-header justify-content-between">
        ...
        <div class="d-flex justify-content-between col-auto">
            @can('editar empresa')
            <div class="me-2">
                <a href=" {{ route('admin.empresa.edit', ['empresa' => $empresa ]) }}" class="btn btn-secondary w-100">
            ...
            @if($empresa->academicosEstagio->count() == 0)
                ...
                <div>
                    <form id="form_{{$empresa->id}}" method="post" action="{{ route('admin.empresa.destroy', ['empresa' => $empresa]) }}">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#modal-destroy-empresa" class="btn btn-danger w-100">
