...
<div class="col-12">
    <div class="card m-3">
        <div class="card-header justify-content-between">
            ...
            @endif
            <div>
                <a href="{{ route('admin.permission.create') }}" class="btn btn-success w-100 mb-1">
        ...
        <table class="display w-100" id="tabela-permissions"> {{-- table card-table table-vcenter text-nowrap datatable --}}
          ...
          <tbody>
            ...
            <tr>
                ...
                <td class="text-end">
                    <a class="btn justify-content-center" href="{{ route('admin.permission.show', ['permission' => $permission]) }}">
