                ...
                <td class="d-flex align-items-center justify-content-center text-end">
                    <div>
                        <a href="{{ route('admin.semestre.show', ['semestre' => $s]) }}" class="btn btn-secondary w-100 ">
                            <svg  xmlns="http://www.w3.org/2000/svg"   width="21"  height="21"  viewBox="0 0 21 21"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="d-flex justify-content-center"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" /><path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" /></svg>
                        </a>
                    </div>
                    <div>
                        <a href="{{ route('admin.semestre.edit', ['semestre' => $s]) }}" class="btn btn-primary w-100 ">
                            <svg xmlns="http://www.w3.org/2000/svg"  class="d-flex justify-content-center" width="21" height="21" viewBox="0 0 21 21" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 20h4l10.5 -10.5a2.828 2.828 0 1 0 -4 -4l-10.5 10.5v4" /><path d="M13.5 6.5l4 4" /></svg>
                        </a>
                    </div>
                    <div>
