            ...
            <form method="POST" action="{{ route('admin.cadastro-academico') }}" enctype="multipart/form-data" class="row g-3 align-items-center">
                ...
                <div class="divide-y">
                    <div>
                        <label class="row">
                            @if ($semestreAtivo)
                                <span class="col">Ativar o cadastro dos academicos no semestre ativo</span>
                                <span class="col-auto">
                                    <label class="form-check form-check-single form-switch">
                                        <input class="form-check-input" id="ativar" name="ativar" type="checkbox" checked>
                            @else
                                <span class="col">Ative um semestre para poder ativar o cadastro dos academicos</span>
                                <span class="col-auto">
                                    <label class="form-check form-check-single form-switch">
