...
class PerfisEPermissoesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissionsOrientador = collect([
            ['guard_name' => 'admin', 'name' => 'permissao de escrita orientador',  'description' => 'Permite a atuação no semestre atual.'],
        ...
        $permissionsUser = collect([
            ['guard_name' => 'web', 'name' => 'permissao de escrita academico',  'description' => 'Permite a atuação no semestre atual.'],
